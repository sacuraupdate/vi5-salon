...
export const legalDocs: Record<LegalDocId, LegalDoc> = {
  ...
  tokusho: {
    ...
    sections: [
      s('販売事業者', 'Seller',
        '［要確定］事業者名（屋号・法人名または個人事業主の氏名）',
        '[TO BE CONFIRMED] Legal name of the business or sole proprietor.'),
      s('運営責任者', 'Responsible person',
        '［要確定］責任者氏名',
        '[TO BE CONFIRMED] Name of the person responsible.'),
      s('所在地', 'Address',
        '［要確定］所在地。個人事業主の場合、請求があったら遅滞なく開示する旨の記載で足りるかは専門家の確認が必要です。',
        '[TO BE CONFIRMED] Business address. Whether a sole proprietor may instead state that the address is disclosed on request needs professional review.'),
      s('電話番号', 'Phone number',
        '［要確定］電話番号。請求があったら遅滞なく開示する運用とするかを含めて決定が必要です。',
        '[TO BE CONFIRMED] Phone number, including whether it will be disclosed on request rather than published.'),
      s('メールアドレス', 'Email',
        '［要確定］問い合わせ用メールアドレス',
        '[TO BE CONFIRMED] Support email address.'),
      s('販売価格', 'Price',

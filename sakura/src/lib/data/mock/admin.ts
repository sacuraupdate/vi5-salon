...
export const posts: Post[] = [
  {
    id: 'p1',
    title: '日本式サロンスタンダードの制作を始めました',
    body: 'おもてなしを「感覚」ではなく、誰でも再現できるサロンの仕組みにする講座です。全10章の制作を進めています。公開の準備が整いしだい、このページでお知らせします。',
    channel: 'site',
    status: 'published',
    publishAt: '2026-09-02',
    updatedAt: '2026-09-02',
    authorId: 'sakura',
    translations: { en: 'done', 'zh-TW': 'draft' },
  },
  {
    id: 'p2',
    title: 'お迎えの3秒で印象が決まる理由',
    body: 'お客様がドアを開けてから席に着くまでの間に、サロンの印象はほとんど決まります。その3秒で何をしているかを分解します。',
    channel: 'instagram',
    status: 'scheduled',
    publishAt: '2026-09-15',
    updatedAt: '2026-09-09',
    authorId: 'sakura',
    translations: { en: 'draft' },
  },
  {
    id: 'p3',
    title: '清潔感は「掃除の頻度」ではなく「見える場所の基準」',
    body: '毎日掃除していても清潔に見えないサロンがあります。お客様の視線が届く場所に基準を置くという考え方について。',
    channel: 'site',
    status: 'draft',
    publishAt: null,
  ...
  {
    id: 'p4',
    title: '月経周期と肌の関係を、お客様にどう伝えるか',
    body: 'サロンで聞かれることの多い質問です。専門用語を使わずに説明するための言い換えをまとめました。',
    channel: 'site',
    status: 'published',
  ...
  {
    id: 'p5',
    title: '更年期前後のお客様への声かけで気をつけていること',
    body: '体の変化はデリケートな話題です。こちらから断定せず、お客様が話しやすい聞き方を意識しています。',
    channel: 'instagram',
    status: 'draft',
    publishAt: null,
    updatedAt: '2026-09-10',

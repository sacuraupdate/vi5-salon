  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8 sm:py-12">
      <header className="mb-8 flex flex-col gap-2">
        <span className="text-[11px] font-medium tracking-[0.16em] text-crimson uppercase">Free</span>
          ...
          return (
            <Card key={item.id} hover className="flex h-full flex-col overflow-hidden">
              ...
              <div className="flex flex-1 flex-col gap-2 p-4">
                <span className="text-[11px] tracking-wider text-crimson uppercase">
                ...
                <div className="mt-auto flex items-center justify-between pt-3">
                  ...
                  <span className="inline-flex items-center gap-1 text-[13px] text-crimson">
                    {f('start')}

  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-10 sm:py-14">
      ...
      <form className="mt-8 flex flex-col gap-4">
        <Field id="name" label={c('name')} autoComplete="name" />
        <Field id="email" label={c('email')} type="email" autoComplete="email" placeholder="you@example.com" />
